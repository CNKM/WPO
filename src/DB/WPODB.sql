CREATE DATABASE  IF NOT EXISTS `WPO` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_bin */;
USE `WPO`;
...
CREATE TABLE `T_SYS_UserInfo` (
  ...
  `F_UserName` varchar(45) CHARACTER SET utf8 DEFAULT '',
...
INSERT INTO `T_SYS_UserInfo` VALUES ('F963C78E-6914-11E7-8C5B-B8975A0F894D','admin','admin','root','2017-07-15 12:22:19','root','2017-07-15 12:22:19');
...
-- Dump completed on 2017-07-15 12:43:53
